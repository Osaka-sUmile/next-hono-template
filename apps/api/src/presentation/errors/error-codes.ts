export const ErrorCodes = {
  ...
  FEEDBACK_SURVEY_SLUG_CONFLICT: "FEEDBACK_SURVEY_SLUG_CONFLICT",
  FEEDBACK_SURVEY_NOT_PUBLISHABLE: "FEEDBACK_SURVEY_NOT_PUBLISHABLE",
  FEEDBACK_SURVEY_MUST_BE_INACTIVE: "FEEDBACK_SURVEY_MUST_BE_INACTIVE",
  FEEDBACK_SURVEY_HAS_SUBMISSIONS: "FEEDBACK_SURVEY_HAS_SUBMISSIONS",
